  ...
  useEffect(() => {
    const fetchProjects = async () => {
      try {
        ...
        const userProjects = ideas.filter((idea: any) => {
          // Vérifier si createdBy contient le record ID de l'utilisateur
          return idea.createdBy && idea.createdBy.includes(user?.id);
        });
